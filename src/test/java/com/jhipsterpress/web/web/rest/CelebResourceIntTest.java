...
public class CelebResourceIntTest {
     ...
     *
     * @see com.jhipsterpress.web.repository.search.CelebSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createCeleb() throws Exception {
        ...
        verify(mockCelebSearchRepository, times(1)).save(testCeleb);
    }
    ...
    public void createCelebWithExistingId() throws Exception {
        ...
        // Validate the Celeb in Elasticsearch
        verify(mockCelebSearchRepository, times(0)).save(celeb);
    }
    ...
    public void deleteCeleb() throws Exception {
        ...
        // Validate the Celeb in Elasticsearch
        verify(mockCelebSearchRepository, times(1)).deleteById(celeb.getId());
    }
    ...
    public void searchCeleb() throws Exception {
        // Initialize the database
        celebRepository.saveAndFlush(celeb);
        when(mockCelebSearchRepository.search(queryStringQuery("id:" + celeb.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(celeb), PageRequest.of(0, 1), 1));
        // Search the celeb

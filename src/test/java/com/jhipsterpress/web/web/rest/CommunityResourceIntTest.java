...
public class CommunityResourceIntTest {
     ...
     *
     * @see com.jhipsterpress.web.repository.search.CommunitySearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchCommunity() throws Exception {
        // Initialize the database
        communityRepository.saveAndFlush(community);
        when(mockCommunitySearchRepository.search(queryStringQuery("id:" + community.getId()), PageRequest.of(0, 20)))

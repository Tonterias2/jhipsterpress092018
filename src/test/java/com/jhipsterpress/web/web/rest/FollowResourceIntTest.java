...
public class FollowResourceIntTest {
     ...
     *
     * @see com.jhipsterpress.web.repository.search.FollowSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void searchFollow() throws Exception {
        // Initialize the database
        followRepository.saveAndFlush(follow);
        when(mockFollowSearchRepository.search(queryStringQuery("id:" + follow.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(follow), PageRequest.of(0, 1), 1));
        // Search the follow

...
public class FrontpageconfigResourceIntTest {
     ...
     *
     * @see com.jhipsterpress.web.repository.search.FrontpageconfigSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createFrontpageconfig() throws Exception {
        ...
        verify(mockFrontpageconfigSearchRepository, times(1)).save(testFrontpageconfig);
    }
    ...
    public void createFrontpageconfigWithExistingId() throws Exception {
        ...
        // Validate the Frontpageconfig in Elasticsearch
        verify(mockFrontpageconfigSearchRepository, times(0)).save(frontpageconfig);
    }
    ...
    public void deleteFrontpageconfig() throws Exception {
        ...
        // Validate the Frontpageconfig in Elasticsearch
        verify(mockFrontpageconfigSearchRepository, times(1)).deleteById(frontpageconfig.getId());
    }
    ...
    public void searchFrontpageconfig() throws Exception {
        // Initialize the database
        frontpageconfigRepository.saveAndFlush(frontpageconfig);
        when(mockFrontpageconfigSearchRepository.search(queryStringQuery("id:" + frontpageconfig.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(frontpageconfig), PageRequest.of(0, 1), 1));

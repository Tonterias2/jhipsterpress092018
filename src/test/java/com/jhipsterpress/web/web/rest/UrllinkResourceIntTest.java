...
public class UrllinkResourceIntTest {
     ...
     *
     * @see com.jhipsterpress.web.repository.search.UrllinkSearchRepositoryMockConfiguration
     */
    @Autowired
    ...
    public void createUrllink() throws Exception {
        ...
        verify(mockUrllinkSearchRepository, times(1)).save(testUrllink);
    }
    ...
    public void createUrllinkWithExistingId() throws Exception {
        ...
        // Validate the Urllink in Elasticsearch
        verify(mockUrllinkSearchRepository, times(0)).save(urllink);
    }
    ...
    public void deleteUrllink() throws Exception {
        ...
        // Validate the Urllink in Elasticsearch
        verify(mockUrllinkSearchRepository, times(1)).deleteById(urllink.getId());
    }
    ...
    public void searchUrllink() throws Exception {
        // Initialize the database
        urllinkRepository.saveAndFlush(urllink);
        when(mockUrllinkSearchRepository.search(queryStringQuery("id:" + urllink.getId()), PageRequest.of(0, 20)))
            .thenReturn(new PageImpl<>(Collections.singletonList(urllink), PageRequest.of(0, 1), 1));
        // Search the urllink
